...
export const Hudson = ({ children: inputImageTexture }) => (
  <Node
    shader={shaders.Hudson}
    uniforms={{
      inputImageTexture,
      inputImageTexture2: resolveAssetSource(
        require("../assets/filters/hudsonBackground.png")
      ),
      inputImageTexture3: resolveAssetSource(
        require("../assets/filters/overlayMap.png")
      ),
      inputImageTexture4: resolveAssetSource(
        require("../assets/filters/hudsonMap.png")
      ),
    }}
  />
);
