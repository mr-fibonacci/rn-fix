...
export const Toaster = ({ children: inputImageTexture }) => (
  <Node
    shader={shaders.Toaster}
    uniforms={{
      inputImageTexture,
      inputImageTexture2: resolveAssetSource(
        require("../assets/filters/toasterMetal.png")
      ),
      inputImageTexture3: resolveAssetSource(
        require("../assets/filters/toasterSoftLight.png")
      ),
      inputImageTexture4: resolveAssetSource(
        require("../assets/filters/toasterCurves.png")
      ),
      inputImageTexture5: resolveAssetSource(
        require("../assets/filters/toasterOverlayMapWarm.png")
      ),
      inputImageTexture6: resolveAssetSource(
        require("../assets/filters/toasterColorShift.png")
      ),
    }}
  />
);
